...
public abstract class AbstractAlgoBackTest extends SequencerTestCase {
    ...
    protected UnsafeBuffer Tick4(){
        ...
        encoder.bidBookCount(4)
                .next().price(101L).size(200L)
                .next().price(100L).size(700L)
                .next().price(98L).size(1000L)
                .next().price(92L).size(3000L);
    ...
    protected UnsafeBuffer Tick5(){
        ...
        encoder.bidBookCount(4)
                .next().price(101L).size(200L)
                .next().price(100L).size(700L)
                .next().price(99L).size(1000L)
                .next().price(93L).size(3000L);
    ...
    protected UnsafeBuffer TickX(){
        ...
        encoder.bidBookCount(4)
                ...
                .next().price(92L).size(700L)
                .next().price(90L).size(1000L)
                .next().price(89L).size(3000L);

        encoder.askBookCount(4)
                .next().price(96L).size(501L)
                .next().price(99L).size(300L)
                .next().price(100).size(2000L)
                .next().price(103).size(3000L);
    ...
    protected UnsafeBuffer TickTightSpread(){
    ...
    protected UnsafeBuffer TickWideSpread(){
